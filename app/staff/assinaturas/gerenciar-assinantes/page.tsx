...
export default function StaffGerenciarAssinantes() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">Meus Assinantes</h1>
          <p className="text-sm md:text-base text-muted-foreground">
            Valide pagamentos mensais dos seus clientes assinantes
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
          <Card className="border-gold/20">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Meus Assinantes</CardTitle>
        ...
        <Card className="border-gold/20 mb-6">
          <CardContent className="pt-6">
            <div className="space-y-2">
              ...
              <Input
                id="search"
                placeholder="Nome do cliente ou plano..."
                value={searchTerm}
            ...
            <Card className="border-gold/20">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-muted-foreground">
                  {searchTerm ? "Nenhum assinante encontrado com este termo" : "Você ainda não possui assinantes"}
                </p>
              </CardContent>
            </Card>
          )}
